...
main(int argc, char *argv[])
{
  ...
  // your code to print the time in any format you like...
	printf(2, "");
   9:	c7 44 24 04 29 07 00 	movl   $0x729,0x4(%esp)
  10:	00 
  11:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  18:	e8 a3 03 00 00       	call   3c0 <printf>
	printf(2, "%d\n", nice() );
  1d:	e8 f0 02 00 00       	call   312 <nice>
  22:	c7 44 24 04 26 07 00 	movl   $0x726,0x4(%esp)
  29:	00 
  2a:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  31:	89 44 24 08          	mov    %eax,0x8(%esp)
  35:	e8 86 03 00 00       	call   3c0 <printf>

  exit();
  3a:	e8 23 02 00 00       	call   262 <exit>
  3f:	90                   	nop
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 359:	0f b6 92 31 07 00 00 	movzbl 0x731(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 4ef:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 4f1:	b8 2a 07 00 00       	mov    $0x72a,%eax
...
free(void *ap)
{
 ...
 5b1:	a1 a8 09 00 00       	mov    0x9a8,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 5f7:	89 10                	mov    %edx,(%eax)
  freep = p;
 5f9:	a3 a8 09 00 00       	mov    %eax,0x9a8
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61f:	03 4b fc             	add    -0x4(%ebx),%ecx
    ...
    p->s.ptr = bp;
  freep = p;
 622:	a3 a8 09 00 00       	mov    %eax,0x9a8
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 1d a8 09 00 00    	mov    0x9a8,%ebx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
...
morecore(uint nu)
{
 ...
 689:	89 c2                	mov    %eax,%edx
    ...
    if(p == freep)
 68b:	3b 15 a8 09 00 00    	cmp    0x9a8,%edx
...
morecore(uint nu)
{
 ...
 6bd:	e8 ee fe ff ff       	call   5b0 <free>
  return freep;
 6c2:	8b 15 a8 09 00 00    	mov    0x9a8,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6e4:	89 70 04             	mov    %esi,0x4(%eax)
      ...
      freep = prevp;
 6e7:	89 15 a8 09 00 00    	mov    %edx,0x9a8
      return (void*)(p + 1);
 ...
 6fc:	eb e9                	jmp    6e7 <malloc+0xa7>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6fe:	c7 05 a8 09 00 00 ac 	movl   $0x9ac,0x9a8
 705:	09 00 00 
    base.s.size = 0;
 708:	ba ac 09 00 00       	mov    $0x9ac,%edx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 70d:	c7 05 ac 09 00 00 ac 	movl   $0x9ac,0x9ac
 714:	09 00 00 
    base.s.size = 0;
 717:	c7 05 b0 09 00 00 00 	movl   $0x0,0x9b0
 71e:	00 00 00 
